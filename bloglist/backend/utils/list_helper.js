...
const mostBlogs = (blogs) => {
  ...
  const authorWithMostBlogs = lo.maxBy(
...
const mostLikes = (blogs) => {
  ...
  const authorWithMostLikes = lo.maxBy(
    Object.keys(groupedByAuthor),
    (author) => groupedByAuthor[author],
    'likes',
  )

  const mostLikesAmount = lo.sumBy(
    groupedByAuthor[authorWithMostLikes],
    'likes',
  )
